    ...
    return (
        <>
            {loading ? (
                ...
                <>
                    <h1 className="text-2xl font-semibold">Last Pitstop</h1>
                    {pitStops.map((pitStop, index) => (
                        <div key={index} className="flex items-center text-gray-500 bg-gray-200 rounded-lg border-2 border-indigo-400 mb-2 mt-2">
                            <Link href="#">
                                <div
                                    className="max-w-sm p-4 flex items-center"
                                >
                                    <div>
